...
!(async () => {
//此处填写调用的CK的link
  await getCookies('http://adguard.b.freefrp.net/Cookie.json')
  if (!cookiesArr[0]) {
...
//此处填写被助力的助力码
const jdPlantBeanShareArr=[`k3dwymcajwbpdn4agxe6btk7oi@mlrdw3aw26j3wvxjhlyueurz3bym6nponohq3ba`]
...
//此处填写被助力的助力码
const jdFruitShareArr = [`d0696f341f0a4441a4d80e38ab5e0b9e@127c44acc53e4433ab074bca0b38c295`]
...
//此处填写被助力的助力码
const jdPetShareArr = [`MTAxODc2NTEzMTAwMDAwMDAzMjYwNjA5MQ==@MTE1NDAxNzgwMDAwMDAwMzk3NDgwNTk=`]
// 格式化
function shareCodesFormat() {
  return new Promise(async resolve => {
...
const jdcrazyjoyArr = [`ylbxZfv8kbc=@QTz_ilKIE83r8xJMUKsHZKt9zd5YaBeE`]
// 格式化
function shareCodesFormat() {
  return new Promise(async resolve => {
...
//此处填写被助力的助力码
jdCashArr=[`flhiK7ng@eU9Yab2yM_ok8D_cwnQUhQ`]
// 格式化
function shareCodesFormat() {
  return new Promise(async resolve => {
...
// 📣京喜工厂✅
async function helpdreamFactory() {

//此处填写被助力的助力码
jxdreamFactoryShareArr=[`LyU3MkgQ9TQR4aqK0HVj5Q==@X19r6jziMAzahz96guTouA==`]


//格式化助力码
function shareCodesFormat() {
  return new Promise(async resolve => {
    newShareCodes = jxdreamFactoryShareArr[0].split('@');
    console.log(`第${$.index}个京东账号将要助力的好友${JSON.stringify(newShareCodes)}`)
    resolve();
  })
}
