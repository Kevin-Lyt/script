...
async function joinLeaderTuan() {
  if (!$.tuanIdS) await updateTuanIdsCDN('http://adguard.mseweb.tk/shareCodes/jd_updateFactoryTuanId.json');
...
function updateTuanIds(url = 'http://adguard.mseweb.tk/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(resolve => {
...
function updateTuanIdsCDN(url = 'http://adguard.mseweb.tk/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    $.get({url,
      headers:{
...
function helpAuthor1(_0x383f29 = 'http://adguard.mseweb.tk/shareCodes/jd_barGain.json') {
    var _0x40f502 = {
        'kklOp': 'inBargaining',
...
function helpAuthor2(_0x10a6dc = 'http://adguard.mseweb.tk/shareCodes/jd_barGain.json') {
    var _0x335dd9 = {
...
_0xodT = 'jsjiami.com.v6'// prettier-ignore
