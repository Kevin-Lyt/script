...
function vviptask_reach_task(_0x599345) {
    ...
    const _0x25f59c = {
        'url': JD_API_HOST + '?functionId=vviptask_reach_task&body=' + _0x4ed305['mCZGr'](escape, JSON['stringify'](_0x6aa9f)) + '&appid=swat_miniprogram&fromType=wxapp&timestamp=' + _0x4ed305['zQKgd'](_0x4ed305['zQKgd'](new Date()['getTime'](), _0x4ed305['JWvBb'](_0x4ed305['JWvBb'](new Date()['getTimezoneOffset'](), 0x3c), 0x3e8)), _0x4ed305['Fxhui'](_0x4ed305['JHaWc'](_0x4ed305['JHaWc'](0x8, 0x3c), 0x3c), 0x3e8)),
        'headers': {
...
function vviptask_reward_receive(_0x359f65) {
    ...
    const _0x1b25d9 = {
        'url': JD_API_HOST + '?functionId=vviptask_reward_receive&body=' + _0x480ae3['rlldh'](escape, JSON['stringify'](_0x1eec4b)) + '&appid=swat_miniprogram&fromType=wxapp&timestamp=' + _0x480ae3['Uunit'](_0x480ae3['FZRFX'](new Date()['getTime'](), _0x480ae3['WhhWN'](_0x480ae3['OWQch'](new Date()['getTimezoneOffset'](), 0x3c), 0x3e8)), _0x480ae3['OWQch'](_0x480ae3['OWQch'](_0x480ae3['gPcfM'](0x8, 0x3c), 0x3c), 0x3e8)),
        'headers': {
...
function pg_interact_interface_invoke(_0x218102) {
    ...
    const _0x3a438b = {
        'url': JD_API_HOST + '?functionId=pg_interact_interface_invoke&body=' + _0x55afd7['HaSvI'](escape, JSON['stringify'](_0x44e0dc)) + '&appid=swat_miniprogram&fromType=wxapp&timestamp=' + _0x55afd7['WoZsA'](_0x55afd7['WoZsA'](new Date()['getTime'](), _0x55afd7['RFtPt'](_0x55afd7['RFtPt'](new Date()['getTimezoneOffset'](), 0x3c), 0x3e8)), _0x55afd7['ezZvj'](_0x55afd7['ezZvj'](_0x55afd7['ezZvj'](0x8, 0x3c), 0x3c), 0x3e8)),
        'headers': {
...
function taskUrl(_0x41ffe4, _0xdde8d6 = {}) {
    ...
    return {
        'url': JD_API_HOST + '?functionId=' + _0x41ffe4 + '&body=' + _0x4216df['ZiTKO'](escape, JSON['stringify'](_0xdde8d6)) + '&appid=swat_miniprogram&osVersion=5.0.0&clientVersion=3.1.3&fromType=wxapp&timestamp=' + _0x4216df['CwUIk'](_0x4216df['CwUIk'](new Date()['getTime'](), _0x4216df['TvZRe'](_0x4216df['TvZRe'](new Date()['getTimezoneOffset'](), 0x3c), 0x3e8)), _0x4216df['TvZRe'](_0x4216df['TvZRe'](_0x4216df['TvZRe'](0x8, 0x3c), 0x3c), 0x3e8)),
        'headers': {
